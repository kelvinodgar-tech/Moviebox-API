...
```bash
curl "https://your-project.vercel.app/api/search?q=oppenheimer&limit=10"
```
...
open "https://your-project.vercel.app/api/stream?url=https%3A%2F%2Fbcdnxw.hakunaymatata.com%2Fresource%2F...mp4"

# Download via curl
curl -O "https://your-project.vercel.app/api/stream?url=https%3A%2F%2Fbcdnxw.hakunaymatata.com%2Fresource%2F...mp4"
```
...
curl -O https://your-project.vercel.app/moviebox_scraper.py
